...
export const offers: Offer[] = [
  ...
  },
  {
    ...
    bullets: ['12 Kapitel, ~120 Lektionen', 'Workbooks + geführte Meditationen', 'Lebenslanger Zugriff'],
    ...
    tiers: [
      {
        ...
        includes: ['12 Kapitel Videokurs', 'Workbooks', 'Geführte Meditationen', 'Lebenslanger Zugriff'],
      },
      {
        name: 'Intensiv',
        price: '697 €',
  ...
  // ───────── F3 — Vor Ort ─────────
  {
    ...
    headline: 'Eine Woche Zypern. Ihr beide. Wir vier.',
